...
students = sorted(students) #['Aaron', 'Bilbo', 'Johnny', 'Khendrik', 'Steve']
...
аverage_score_journal = {students[0]:grades[0], students[1]:grades[1], students[2]:grades[2], students[3]:grades[3], students[4]:grades[4]}
print(аverage_score_journal)
